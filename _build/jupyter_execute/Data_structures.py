...
# data, inserting new data, and removing data. Basic and advanced data structures are used in almost every program or software system that has been developed. {numref}`brief_description` provides a list of basic data structures and a brief description. This is not a complete list of data structures. Instead, I will re-visit the following data structures in detail.
# 
...
# 4. Check if the pasta is cooked
